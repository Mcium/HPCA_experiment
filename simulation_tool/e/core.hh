...
class AcceleratorCore
{
    ...
    public:
        ...
        double CalculationTime(int full_tile_size, double m, double n, double g);
        int DoAccelerate(int delay, int full_tile_size, double m, double n, double g, double power, double calculation_times);
